          ...
          <div className="space-y-6 text-[#134E6F]/80 leading-relaxed">
            <section>
              ...
              <p>
                ...
                <strong>[ЗАПОЛНИТЬ: ИП Фамилия Имя Отчество, ИИН]</strong>,
                зарегистрированного по адресу: <strong>[ЗАПОЛНИТЬ: адрес]</strong>,
                на оказание туристских услуг.
              </p>
              <p>
                Лицензия / номер в реестре турагентов: <strong>[ЗАПОЛНИТЬ]</strong>.
